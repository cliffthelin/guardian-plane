...
pub const INTERFACE_NAME: &str = "org.guardianproject.Development.Guardian1";
pub const OBJECT_PATH: &str = "/org/guardianproject/Development/Guardian1";
...
#[zbus::interface(name = "org.guardianproject.Development.Guardian1")]
