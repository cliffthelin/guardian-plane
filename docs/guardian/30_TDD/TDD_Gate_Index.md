...
|---|---|---|---|
| G0 | Public contracts | [D-Bus API](../20_Control_Plane/D-Bus_API_Contract.md), [Source drift](../20_Control_Plane/Source_Contract_Drift.md) | [Implementation](GUARDIAN_PHASE_0_IMPLEMENTATION_HANDOFF.md), [Independent review](GUARDIAN_G0_INDEPENDENT_REVIEW_HANDOFF.md), [Milestone](../../evidence/g0/G0_MILESTONE.md) |
| G1 | Identity & authorization | [Privilege & Authorization](../20_Control_Plane/Privilege_and_Authorization.md), [polkit](../10_Platform/Polkit.md) | [Implementation](GUARDIAN_G1_IMPLEMENTATION_HANDOFF.md), [Independent review](GUARDIAN_G1_INDEPENDENT_REVIEW_HANDOFF.md) |
| G2 | Privilege topology | [Privilege & Authorization](../20_Control_Plane/Privilege_and_Authorization.md), [systemd](../10_Platform/systemd.md) | |
