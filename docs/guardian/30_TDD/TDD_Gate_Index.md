...
| G6 | Indicator decision — **PASS (ksni selected), not tagged (spike gate, no guardian-core module)** | [StatusNotifierItem](../10_Platform/StatusNotifierItem.md), [Client Surfaces](../20_Control_Plane/Client_Surfaces.md) | [Implementation](GUARDIAN_G6_IMPLEMENTATION_HANDOFF.md), [Independent review](GUARDIAN_G6_INDEPENDENT_REVIEW_HANDOFF.md), [ADR-006](../../adr/ADR-006-guardian-indicator-mechanism.md), [Milestone](../../evidence/g6/G6_MILESTONE.md) |
