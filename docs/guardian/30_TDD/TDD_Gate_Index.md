...
| Gate | Purpose | Primary wiki pointers |
|---|---|---|
| G0 | Public contracts | [D-Bus API](../20_Control_Plane/D-Bus_API_Contract.md), [Source drift](../20_Control_Plane/Source_Contract_Drift.md) |
| G1 | Identity & authorization | [Privilege & Authorization](../20_Control_Plane/Privilege_and_Authorization.md), [polkit](../10_Platform/Polkit.md) |
