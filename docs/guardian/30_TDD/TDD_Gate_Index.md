...
| G2 | Privilege topology — **prepared, not implemented** | [Privilege & Authorization](../20_Control_Plane/Privilege_and_Authorization.md), [systemd](../10_Platform/systemd.md) | [Implementation](GUARDIAN_G2_IMPLEMENTATION_HANDOFF.md), [Independent review](GUARDIAN_G2_INDEPENDENT_REVIEW_HANDOFF.md) |
