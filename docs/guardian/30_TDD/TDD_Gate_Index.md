...
| G3 | Core data models — **handoffs prepared, not implemented** | [Capability Registry](../20_Control_Plane/Capability_Registry.md), [Provider Arbitrator](../20_Control_Plane/Provider_Arbitrator.md), [Events](../20_Control_Plane/Event_and_Incident_Model.md) | [Implementation](GUARDIAN_G3_IMPLEMENTATION_HANDOFF.md), [Independent review](GUARDIAN_G3_INDEPENDENT_REVIEW_HANDOFF.md) |
